...
module.exports = "/* You can add global styles to this file, and also import other style files */\n.button {\n  background-color: transparent;\n  color: #1d74f5;\n  border: 1px solid #1d74f5;\n  background-color: #1f2329;\n  padding: 10px 15px;\n  text-align: center;\n  display: block;\n  text-decoration: none; }\n.button--large {\n  width: 100%;\n  margin-bottom: 20px; }\n.icon-button {\n  background-color: #f6c502;\n  font-size: 50px;\n  border: none;\n  border-radius: 50%;\n  padding: 5px;\n  color: #000;\n  -webkit-box-shadow: 0 0 7px 1px #000;\n          box-shadow: 0 0 7px 1px #000;\n  text-decoration: none;\n  z-index: 2; }\n.icon-button--main-bbar {\n  position: absolute;\n  right: 15px;\n  bottom: 15px; }\n.icon-button--back {\n  font-size: 30px;\n  padding: 6px;\n  position: absolute;\n  top: 5px;\n  left: 20px; }\n.icon-button--delete-way {\n  position: absolute;\n  top: 2px;\n  right: 15px; }\n.icon-button--add-station {\n  position: absolute;\n  bottom: 18px;\n  right: 90px; }\n.icon-button--s {\n  font-size: 40px;\n  padding: 4px; }\n.icon-button--xs {\n  font-size: 30px;\n  padding: 3px; }\n@font-face {\n  font-family: 'icons';\n  src: url(\"/stairway-to-train/assets/fonts/icons.ttf?tse0k9\") format(\"truetype\"), url(\"/stairway-to-train/assets/fonts/icons.woff?tse0k9\") format(\"woff\"), url(\"/stairway-to-train/assets/fonts/icons.svg?tse0k9#icons\") format(\"svg\");\n  font-weight: normal;\n  font-style: normal; }\n[class^=\"icon-\"], [class*=\" icon-\"] {\n  /* use !important to prevent issues with browser extensions that change fonts */\n  font-family: 'icons' !important;\n  speak: none;\n  font-style: normal;\n  font-weight: normal;\n  font-variant: normal;\n  text-transform: none;\n  line-height: 1;\n  /* Better Font Rendering =========== */\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale; }\n.icon-icon_garbage:before {\n  content: \"\\e90a\"; }\n.icon-icon_edit:before {\n  content: \"\\e900\"; }\n.icon-icon_add:before {\n  content: \"\\e901\"; }\n.icon-icon_abort:before {\n  content: \"\\e902\"; }\n.icon-icon_back:before {\n  content: \"\\e903\"; }\n.icon-icon_escalator:before {\n  content: \"\\e904\"; }\n.icon-icon_home:before {\n  content: \"\\e905\"; }\n.icon-icon_train:before {\n  content: \"\\e906\"; }\n.icon-icon_check:before {\n  content: \"\\e907\"; }\n.icon-icon_start:before {\n  content: \"\\e908\"; }\n.icon-icon_elevator:before {\n  content: \"\\e909\"; }\n.icon-spinner:before {\n  content: \"\\e97d\"; }\n.icon-refresh:before {\n  content: \"\\e984\"; }\n.icon-rocket:before {\n  content: \"\\e9a5\"; }\n.icon-fire:before {\n  content: \"\\e9a9\"; }\n.icon-star:before {\n  content: \"\\e9d9\"; }\nhtml {\n  -webkit-box-sizing: border-box;\n          box-sizing: border-box; }\n*, ::before, ::after {\n  -webkit-box-sizing: inherit;\n          box-sizing: inherit; }\nbody {\n  background-color: #2f343d;\n  color: #fff;\n  font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;\n  margin: 0px; }\n.main-headline {\n  border-top: 1px solid #fff;\n  border-bottom: 1px solid #fff; }\ninput:focus,\nselect:focus,\ntextarea:focus,\nbutton:focus {\n  outline: none; }\ninput {\n  width: 100%;\n  border: none;\n  border-bottom: 8px solid #ffd21f;\n  font-size: 20px;\n  padding: 12px 7px;\n  margin: 20px 0;\n  color: #2f343d; }\n.bbar {\n  position: fixed;\n  left: 50%;\n  bottom: 0;\n  width: 100%;\n  max-width: 550px;\n  -webkit-transform: translate(-50%, 0);\n          transform: translate(-50%, 0);\n  height: 1px;\n  z-index: 2; }\n.tbar {\n  position: fixed;\n  left: 50%;\n  top: 0;\n  width: 100%;\n  max-width: 550px;\n  -webkit-transform: translate(-50%, 0);\n          transform: translate(-50%, 0);\n  height: 55px;\n  background-color: #1f2329;\n  z-index: 3; }\n.nothing-to-see-here-notice {\n  color: #1f2329;\n  padding: 5px;\n  text-shadow: 1px 1px 0px #414852;\n  font-weight: bold;\n  font-size: 20px; }\n.nothing-to-see-here-notice__icon {\n    position: relative;\n    top: 5px;\n    left: 0px;\n    font-size: 25px; }\n"
